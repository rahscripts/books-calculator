...
export default function Home() {
  return (
    <main className="h-screen bg-white text-black selection:bg-black selection:text-white relative overflow-y-scroll snap-y snap-mandatory scroll-smooth font-sans">
      ...
      {/* -----------------------------------------------------------------
         ...
         ------------------------------------------------------------------ */}
      <section className="min-h-screen w-full flex flex-col relative snap-center">
        {/* Nav Absolute or Top */}
        <nav className="w-full p-6 md:p-10 flex justify-between items-center z-50 absolute top-0 left-0 right-0">
          <Link href={"/"}>
      ...
      {/* -----------------------------------------------------------------
         Section 3: Workflow
         ------------------------------------------------------------------ */}
      <section className="min-h-screen w-full flex items-center justify-center snap-center bg-neutral-50/50 border-y border-neutral-100 p-4 relative z-10">
      ...
      {/* -----------------------------------------------------------------
         ...
         ------------------------------------------------------------------ */}
      <section className="min-h-screen w-full flex flex-col items-center justify-center snap-center p-4 relative z-10">
        ...
        {/* Footer at bottom of this screen */}
