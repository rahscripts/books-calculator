...
import SketchyDivider from "./components/landing/SketchyDivider";
import SketchyVerticalBorder from "./components/landing/SketchyVerticalBorder";
  ...
  return (
    ...
    <main className="h-dvh bg-white text-black selection:bg-black selection:text-white relative overflow-y-scroll scroll-smooth font-sans">
      <div className="relative w-full max-w-6xl mx-auto">
        {/* Vertical Borders */}
        <SketchyVerticalBorder side="left" className="hidden md:block" />
        <SketchyVerticalBorder side="right" className="hidden md:block" />
